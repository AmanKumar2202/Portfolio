...
export default function Navigation() {
  ...
  return <header className="site-header"><nav className="nav-shell" aria-label="Main navigation">
    ...
    <div className={`nav-links ${open ? "open" : ""}`}><a href={href("#experience")}>Experience</a><a href={href("#projects")}>Work</a><a href={href("#skills")}>Skills</a><a href={href("#resume")}>Resume</a><a href={href("#about")}>About</a><a href={href("#contact")}>Contact</a></div>
