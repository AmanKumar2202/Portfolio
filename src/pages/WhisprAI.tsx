  ...
  const features = [
    {
      ...
      desc: "Instant message delivery with WebSocket technology for seamless, lag-free communication across all devices.",
    },
    {
      icon: <Sparkles className="w-8 h-8" />,
      title: "AI-Powered Bot",
      desc: "Intelligent bot that mimics human conversational style with context-aware smart reply suggestions.",
    },
    {
      icon: <Lock className="w-8 h-8" />,
      title: "Secure Authentication",
      desc: "MongoDB-powered secure authentication with real-time data synchronization and absolute privacy.",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-emerald-400 tracking-widest uppercase font-bold text-sm">
                Case Study
              </span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-2xl leading-relaxed mb-10">
              A WhatsApp-inspired chat application integrated with an AI bot
              that mimics human conversational style, featuring real-time
              messaging and personality-based chat modes.
            </p>
            ...
            <div className="lg:col-span-4 relative">
              <div className="sticky top-32">
                ...
                <p className="text-lg text-slate-400 mb-8">
                  Engineered for absolute zero-latency communication while
                  processing complex NLP models in real-time.
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={tech}
                      className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 rounded-xl text-sm font-semibold"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-slate-400">
                Dynamic AI shifts between Professional, Casual, Creative, and
                Technical tones seamlessly.
              </p>
            </motion.div>
